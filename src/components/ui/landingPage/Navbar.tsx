                ...
                return (
                  <div key={link.title}>
                    <Popover className="relative">
                      ...
                      <PopoverPanel className="animate-in fade-in slide-in-from-top-2 absolute z-10 mt-1 w-52 rounded border border-gray-200 bg-white shadow-lg transition-all duration-300">
